package com.example.application.views.usersdetails;
...
@RolesAllowed("admin")
@Uses(Icon.class)
public class UsersDetailsView extends Div implements BeforeEnterObserver {
    ...
    public UsersDetailsView(@Autowired SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("users-details-view", "flex", "flex-col", "h-full");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(UsersDetailsView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(UsersDetailsView.class);
            }
        }
    }
